...
async def run_autogen_query(query: str):
    ...
    try:
        ...
        console.print(f"[yellow]用户代理配置:[/yellow]")
        console.print(f"  human_input_mode: {user_proxy.human_input_mode}")
        console.print(f"  max_consecutive_auto_reply: {user_proxy.max_consecutive_auto_reply}")
